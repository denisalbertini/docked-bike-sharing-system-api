...
export default class ChargeFacade extends BaseFacade {
  ...
  async chargeLateFees() {
    ...
    if ( findChargesResult.isFailure ) {
      console.error( findChargesResult.errorType );
      console.error( findChargesResult.errors );
    }
    ...
    for ( const charge of charges ) {
      ...
      if ( chargeCompleteResult.isFailure ) {
      console.error( chargeCompleteResult.errorType );
      console.error( chargeCompleteResult.errors );
    }
    }
